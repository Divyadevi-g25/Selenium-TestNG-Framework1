...
public class ExtentManager {
	...
	public synchronized static void attachScreenshot(WebDriver driver, String message) {
		try {
			...
			// getTest().info(message,com.aventstack.extentreports.MediaEntityBuilder.createScreenCaptureFromPath(screenShotPath).build());
		} catch (Exception e) {
	...
	public static void registerDriver(WebDriver driver) {
		driverMap.put(Thread.currentThread().getId(), driver); // .getId() = .threadId()
	}
